...
COPY target/spring-boot-azure-webapp-1.0.0-SNAPSHOT.jar spring-boot-azure-webapp-1.0.0-SNAPSHOT.jar
RUN chown azureuser:azureuser spring-boot-azure-webapp-1.0.0-SNAPSHOT.jar
USER azureuser
